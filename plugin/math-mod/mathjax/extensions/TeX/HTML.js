...
MathJax.Hub.Register.StartupHook("TeX Jax Ready",function () {
  ...
  TEX.Parse.Augment({
    ...
    INJECT_arbitrary: function (name) {
      var parameter = this.GetArgument(name);
      var value = this.GetArgument(name);
      var math = this.GetArgumentMML(name);
      var t = {};
      t[parameter] = value;
      this.Push(math.With(t));
    }
